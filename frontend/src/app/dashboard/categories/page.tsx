    ...
    <div className="flex flex-col h-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--text-2)] text-sm mt-1">Organize suas tarefas de forma eficiente.</p>
        </div>
        <button
      ...
      {error ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center glass rounded-[var(--radius-lg)] border-dashed border-2 py-16">
          ...
          <p className="text-[var(--text-2)] text-sm mb-4">Crie sua primeira categoria de organização.</p>
